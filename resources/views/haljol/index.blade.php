...
@section('content')
    <div class="">
        <p class="fs-1">HAL MENONJOL PAGE</p>
        <a href="{{ url('haljol/create') }}" class="btn btn-outline-success"><i class="fas fa-plus"></i> Create</a>
            ...
            <tbody>
                @foreach ($getAll as $get)
                    <tr>
                        ...
                        <td>
                        @if ($get->dokumen)
                                <a href="{{ asset('storage/dokumen/' . $get->dokumen) }}" target="_blank">
                                    {{ $get->dokumen }}
                                </a>
                            @else
                        ...
                        <td class="text-center">
                            ...
                            <a href="/haljol/show/{{ $get->id }}" class="btn btn-outline-danger btn-sm">
