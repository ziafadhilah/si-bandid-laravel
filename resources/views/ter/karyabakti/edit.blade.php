    ...
    <form action="/ter/karyabakti/update/{{ $karyabakti->id }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body mt-4">
            <div class="mb-3 row">
                ...
                <div class="col-lg-4">
                    <input type="text" class="form-control" name="sas" value="{{ $karyabakti->sas }}" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label class="col-lg-2 col-form-label">Tanggal</label>
                <div class="col-lg-4">
                    <input type="date" class="form-control" name="tanggal" value="{{ $karyabakti->tanggal }}" required>
                </div>
            </div>
            <div class="mb-3 row">
